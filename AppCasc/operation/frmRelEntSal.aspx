...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/catalog/frmLst.js?v1.1.150611_1234" type="text/javascript"></script>
    <script src="../js/operation/frmRelEntSal.js?v1.1.150611_1234" type="text/javascript"></script>
</asp:Content>

...
<input type="hidden" id="hf_id_estatusMaquila" />
...
<div>
    ...
    <ul class="diasTrabajados">
        ...
        <ItemTemplate>
            <li><a id='<%#Eval ("id") %>' href="#" ><%# Eval("fecha_trabajo","{0:dd/MM/yyyy}") %></a></li>
        </ItemTemplate>
        </asp:Repeater>
    </ul>
</div>
...
<div>
    ...
    <asp:TextBox runat="server" ID="txt_fecha_trabajo"></asp:TextBox>
    <asp:RequiredFieldValidator runat="server" ID="rfv_fecha_trabajo" ErrorMessage="Es necesario proporcionar la fecha de trabajo" ControlToValidate="txt_fecha_trabajo"></asp:RequiredFieldValidator>
</div>
...
<%--<div style="position: relative;">
    <label>Bulto(s) Trabajado(s):</label>
    <asp:TextBox runat="server" CssClass="txtNumber" ID="txt_bulto" Text="0"></asp:TextBox>
    <asp:RequiredFieldValidator runat="server" ID="rfv_bulto" ErrorMessage="Es necesario proporcionar el número de bultos" ControlToValidate="txt_bulto"></asp:RequiredFieldValidator>
    <asp:RangeValidator Type="Integer" CssClass="validator rv_ordenTrabajo" runat="server" ID="rv_bulto" ControlToValidate="txt_bulto" ErrorMessage="Es necesario capturar un número entre 1 y 10,000" MinimumValue="1" MaximumValue="10000"></asp:RangeValidator>
</div>
<div style="position: relative;">
    <label>Pieza(s) Trabajada(s):</label>
    <asp:TextBox runat="server" CssClass="txtNumber" ID="txt_pieza" Text="0"></asp:TextBox>
    <asp:RequiredFieldValidator runat="server" ID="rfv_pieza" ErrorMessage="Es necesario proporcionar el número de piezas" ControlToValidate="txt_pieza"></asp:RequiredFieldValidator>
    <asp:RangeValidator Type="Integer" CssClass="validator rv_ordenTrabajo" runat="server" ID="rv_pieza" ControlToValidate="txt_pieza" ErrorMessage="Es necesario capturar un número entre 1 y 10,000" MinimumValue="1" MaximumValue="10000"></asp:RangeValidator>
</div>
<div>
    <label>Pieza(s) da&ntilde;ada(s):</label>
    <asp:TextBox runat="server" CssClass="txtNumber" ID="txt_pieza_danada" Text="0"></asp:TextBox>
    <asp:RangeValidator CssClass="validator" runat="server" Type="Integer" ID="rv_pieza_danada" ControlToValidate="txt_pieza_danada" ErrorMessage="Es necesario capturar un número entre 0 y 5,000,000" MinimumValue="0" MaximumValue="5000000"></asp:RangeValidator>
</div>--%>

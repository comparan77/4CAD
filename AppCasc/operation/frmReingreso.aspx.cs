...
{
    public partial class frmReingreso : System.Web.UI.Page
    {
        #region Campos
        ...
        //    set
        //    {
        //        Session["__ISREFRESHEntrada"] =  value;
        //    }
        //    get
        //    {
        //        bool boleano;
        //        object o = Session["__ISREFRESHEntrada"];
        //        o = o == null ? "false" : o;
        ...
        protected void click_result(object sender, CommandEventArgs args)
        {
            try
            {
                Response.Redirect("frmReingreso.aspx?_kp=" + args.CommandArgument);
            }
            catch (Exception e)
            {
                ((MstCasc)this.Master).setError = e.Message;
        ...
        protected void btn_buscar_click(object sender, EventArgs args)
        {
            try
            {
                List<Salida> lst = SalidaCtrl.searchByFolioPedimento(txt_dato.Text.Replace(" ", "").Trim());
        ...
        private void loadFirstTime()
        {
            try
            {
                ...
                {
                    int.TryParse(Request.QueryString["_kp"].ToString(), out IdSalida);
                    fillReingreso(IdSalida);
                }
            }
            catch (Exception)
            {

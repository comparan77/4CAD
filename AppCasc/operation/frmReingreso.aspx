<%@ Page Title="" Language="C#" MasterPageFile="~/MstCasc.Master" AutoEventWireup="true" CodeBehind="frmReingreso.aspx.cs" Inherits="AppCasc.operation.frmReingreso" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/operation/frmReingreso.js" type="text/javascript"></script>
</asp:Content>
...
<div id="dialog-confirm" title="Datos de reingreso">
...
<div>
<h3 class="ui-accordion-header ui-helper-reset ui-state-default ui-accordion-header-active ui-state-active ui-corner-top ui-accordion-icons">Reingreso</h3>
<asp:Panel runat="server" ID="pnl_reingreso" CssClass="ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content-active contentSection">
<div>
    <label>Bodega:</label>
...
<asp:Panel runat="server" ID="pnl_documentos" CssClass="ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content-active contentSection" Visible="false">
...
<asp:Panel runat="server" ID="pnl_mercancia" CssClass="ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content-active contentSection" Visible="false">
<div>
    <label>Origen:</label>
...
<asp:Panel runat="server" ID="pnl_transporte" CssClass="ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content-active contentSection" Visible="false">
...
<asp:Panel runat="server" ID="pnl_cantidades" CssClass="ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content-active contentSection" Visible="false">
...
<asp:Panel runat="server" ID="pnl_tipo_entrada" CssClass="ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content-active contentSection" Visible="false">
...
<asp:Panel runat="server" ID="pnl_revision" CssClass="ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content-active contentSection" Visible="false">
<div>
...
<div>
    <asp:Button runat="server" ID="btnGuardar" Text="Guardar" OnClick="btnGuardar_click" Enabled="false" />
</div>
</div>

<div id="div_panel">
<h3 class="ui-accordion-header ui-helper-reset ui-state-default ui-accordion-header-active ui-state-active ui-corner-top">B&uacute;squeda</h3>
...
<div>
    ...
    <asp:TextBox runat="server" ID="txt_dato" Text="3034-3004590"></asp:TextBox>
    <div>
    ...
    <ContentTemplate>
    <ol>
        <asp:Repeater runat="server" ID="rep_resultados">
        <ItemTemplate>
            <li><asp:LinkButton runat="server" Text='<%# Eval("folio") + ", " + Eval("referencia") %>' OnCommand="click_result" CommandArgument='<%# Eval("id") %>' CausesValidation="false"></asp:LinkButton></li>
        </ItemTemplate>
        </asp:Repeater>
    </ol>
    </ContentTemplate>

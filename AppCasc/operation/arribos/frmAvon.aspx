<%@ Page Title="" Language="C#" MasterPageFile="~/MstCasc.Master" AutoEventWireup="true" CodeBehind="frmAvon.aspx.cs" Inherits="AppCasc.operation.arribos.frmAvon" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../js/operation/arribos/frmAvon.js" type="text/javascript"></script>
</asp:Content>
...
<asp:HiddenField runat="server" ID="hf_EsCompartida" Value="0" />
...
<asp:Panel runat="server" ID="pnl_busqueda" Visible="true">
<h3 id="div-search" style="cursor: n-resize;" class="ui-accordion-header ui-helper-reset ui-state-default ui-accordion-header-active ui-state-active ui-corner-top">B&uacute;squeda de Pedimentos</h3>
...
<div id="div_busqueda">
    ...
    <asp:RequiredFieldValidator runat="server" ID="rfv_dato" ControlToValidate="txt_dato" ErrorMessage="Es necesario proporcionar un pedimento" ValidationGroup="grp_busqueda"></asp:RequiredFieldValidator>
    <div>
...
<asp:Panel runat="server" ID="pnl_compartidos" Visible="false">
...
<asp:Panel runat="server" ID="pnl_infoArribo" Visible="false">
...
<table class="tblItems" border="0" cellpadding="2" cellspacing="0">
    <thead>
        ...
        <tr>
            <th><asp:DropDownList runat="server" ID="ddlDocumento"></asp:DropDownList></th>
...
<asp:GridView runat="server" ID="grd_compartidos" AutoGenerateColumns="false" CssClass="grdCasc">
    <Columns>
    <asp:BoundField ItemStyle-HorizontalAlign="Center" DataField="referencia" HeaderText="Pedimento(s) Compartido(s)" />
    </Columns>
</asp:GridView>
</asp:Panel>
</div>

<%@ Page Title="" Language="C#" MasterPageFile="~/MstCasc.Master" AutoEventWireup="true" CodeBehind="frmTransporteChart.aspx.cs" Inherits="AppCasc.report.frmTransporteChart" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/jqPlot/jqplot.logAxisRenderer.min.js" type="text/javascript"></script>
    ...
    <script src="../js/report/frmTransporteChart.js" type="text/javascript"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">

<h3 class="ui-accordion-header ui-helper-reset ui-state-default ui-accordion-header-active ui-state-active ui-corner-top">Gr&aacute;fica de Movimientos</h3>
...
<div>
    <asp:HiddenField runat="server" ID="hfsTransporte" />
    <asp:HiddenField runat="server" ID="hfsCantidad" />
    <div id="divTransporte" style="height:500px; width: 950px; "></div>
</div>
</asp:Content>

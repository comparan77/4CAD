<%@ Page Title="" Language="C#" MasterPageFile="~/MstCasc.Master" AutoEventWireup="true" CodeBehind="frmTransporteLst.aspx.cs" Inherits="AppCasc.catalog.frmTransporteLst" %>
...
<link href="../css/common.css" rel="stylesheet" type="text/css" />
    ...
    <script src="../js/catalog/frmLstTransporte.js?v1.1.150619_1446" type="text/javascript"></script>
</asp:Content>
...
<h3 class="ui-accordion-header ui-helper-reset ui-state-default ui-accordion-header-active ui-state-active ui-corner-top">Listado de Transportes</h3>
    ...
    <tbody>
        <asp:Repeater ID="repRows" runat="server">
            <ItemTemplate>
                    ...
                    <td align="center"><a href='<%# "frmTransporte.aspx?Key=" + Eval("id") + "&Action=Udt" %>'><span class="ui-icon ui-icon-pencil spnIcon"></span></a></td>

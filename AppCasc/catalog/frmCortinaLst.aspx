<%@ Page Language="C#" MasterPageFile="~/MstCasc.Master" AutoEventWireup="true" CodeBehind="frmCortinaLst.aspx.cs" Inherits="AppCasc.catalog.frmCortinaLst" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/catalog/frmLstCortina.js?v1.1.150619_1446" type="text/javascript"></script>
</asp:Content>
...
<h3 class="ui-accordion-header ui-helper-reset ui-state-default ui-accordion-header-active ui-state-active ui-corner-top">Listado de Cortinas</h3>
...
<tbody>
    <asp:Repeater ID="repRows" runat="server">
        <ItemTemplate>
                ...
                <td align="center"><a href='<%# "frmCortina.aspx?Key=" + Eval("id") + "&Action=Udt" %>'><span class="ui-icon ui-icon-pencil spnIcon"></span></a></td>

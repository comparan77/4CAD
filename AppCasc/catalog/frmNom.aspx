<%@ Page Title="" Language="C#" MasterPageFile="~/MstCasc.Master" AutoEventWireup="true" CodeBehind="frmNom.aspx.cs" Inherits="AppCasc.catalog.frmNom" %>
...
<div id="frmCatalog" class="divForm">
    ...
    <div>
        ...
        <asp:TextBox runat="server" ID="txt_descripcion" TextMode="MultiLine" Rows="3" Columns="60"></asp:TextBox>
        <asp:RequiredFieldValidator runat="server" ID="rfvDescripcion" ControlToValidate="txt_descripcion" ErrorMessage="Campo Requerido"></asp:RequiredFieldValidator>
    </div>
    <hr />
    <div id="divActions">   

<%@ Page Title="" Language="C#" MasterPageFile="~/MstCasc.Master" AutoEventWireup="true" CodeBehind="frmClienteCompradorLst.aspx.cs" Inherits="AppCasc.catalog.frmClienteCompradorLst" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/catalog/frmLstClienteComprador.js" type="text/javascript"></script>
</asp:Content>
...
<h3 class="ui-accordion-header ui-helper-reset ui-state-default ui-accordion-header-active ui-state-active ui-corner-top">Listado de Compradores de <asp:HyperLink runat="server" ID="lnkCliente"></asp:HyperLink></h3>
        ...
        <asp:Repeater ID="repRows" runat="server">
            <ItemTemplate>
                <tr id='<%# "row_" + Eval("id") %>'>
                    ...
                    <td align="center"><a href='<%# "frmClienteComprador.aspx?Key=" + Eval("id") + "&Action=Udt" %>'><span class="ui-icon ui-icon-pencil spnIcon"></span></a></td>

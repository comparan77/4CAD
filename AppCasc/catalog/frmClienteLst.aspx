<%@ Page Title="" Language="C#" MasterPageFile="~/MstCasc.Master" AutoEventWireup="true" CodeBehind="frmClienteLst.aspx.cs" Inherits="AppCasc.catalog.frmClienteLst" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   ...
   <%-- <script src="../js/jquery.js" type="text/javascript"></script>
    ...
    <script src="../js/catalog/frmLstCliente.js?v1.1.150619_1446" type="text/javascript"></script>
</asp:Content>
...
<h3 class="ui-accordion-header ui-helper-reset ui-state-default ui-accordion-header-active ui-state-active ui-corner-top">Listado de Clientes</h3>
    ...
    <tbody>
        <asp:Repeater ID="repRows" runat="server">
            <ItemTemplate>
                    ...
                    <td><%# Eval("nombre") %></td>
                    <td><%# Eval("rfc") %></td>
                    <td align="center"><%# Eval("cuenta_tipo") %></td>
                    <td><%# Eval("grupo") %></td>
                    <td align="center"><a href='<%# "frmCliente.aspx?Key=" + Eval("id") + "&Action=Udt" %>'><span class="ui-icon ui-icon-pencil spnIcon"></span></a></td>

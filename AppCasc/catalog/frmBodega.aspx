<%@ Page Title="" Language="C#" MasterPageFile="~/MstCasc.Master" AutoEventWireup="true" CodeBehind="frmBodega.aspx.cs" Inherits="AppCasc.catalog.frmBodega" %>
...
<h3 class="ui-accordion-header ui-helper-reset ui-state-default ui-accordion-header-active ui-state-active ui-corner-top">Bodega</h3>
...
<div id="frmCatalog" class="divForm">
    ...
    <div>
        ...
        <asp:TextBox TextMode="MultiLine" Rows="5" Columns="2" runat="server" ID="txt_direccion"></asp:TextBox>

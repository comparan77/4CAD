<%@ Page Title="" Language="C#" MasterPageFile="~/MstCasc.Master" AutoEventWireup="true" CodeBehind="frmPersonalLst.aspx.cs" Inherits="AppCasc.personal.frmPersonalLst" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/personal/frmLstPersonal.js?v1.1.150619_1446" type="text/javascript"></script>
</asp:Content>
...
<h3 class="ui-accordion-header ui-helper-reset ui-state-default ui-accordion-header-active ui-state-active ui-corner-top">Listado del Personal</h3>

//var LstClientes_documento;
//var LstDocumentos;

var MngEntrada = function () {
    ...
    function init() {
        ...
        //setSaveCacheInfo();
        // Clientes documentos <<ini>>
//        LstClientes_documento = jQuery.parseJSON($('#ctl00_body_hf_clienteDocumento').val());
//        LstDocumentos = jQuery.parseJSON($('#ctl00_body_hf_documentos').val());
...
function setSaveCacheInfo() {
    setTimeout("saveCacheInfo()", 300000); // every 5 min
}

function saveCacheInfo() {
    $('#ctl00_body_btnSaveCache').trigger('click');
    setSaveCacheInfo();
}

var master = new webApp.Master;
var pag = new MngEntrada();
master.Init(pag);
var beanCliente_mercancia = function (id_cliente_grupo, codigo, nombre, clase, negocio) {
...
var ctrlClienteMercancia = function () {
    ...
    function addMercancia() {
        ...
        var oCM = new beanCliente_mercancia(1, $('#txt_codigo').val(), $('#txt_nombre').val(), $('#txt_clase').next().children('input').val(), $('#txt_negocio').next().children('input').val());

...
{
    public class Tarima_almacen_trafico
    {
        #region Campos
        protected int _id;
        ...
        public List<Tarima_almacen_remision> PLstRem { get; set; }
        ...
        public Tarima_almacen_carga PCarga { get; set; }
        public Salida_destino PSalidaDestino { get; set; }
        #endregion

        #region Constructores
        public Tarima_almacen_trafico()
		{
